...
public class GlobalColors {
  ...
  public static final Color CLEAR_WATER_COLOR = new Color(0.4, 0.8, 0.9, 1);
  public static final Color NORMAL_WATER_COLOR = new Color(0.2, 0.5, 0.8, 1);
  public static final Color DEEP_WATER_COLOR = new Color(0.05, 0.1, 0.4, 1);
